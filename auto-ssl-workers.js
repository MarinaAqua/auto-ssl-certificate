export default {
  ...
  <head>
      ...
      <title>IP6.ARPA Tambahkan sertifikat SSL secara otomatis ke nama domain</title>
      <style>
          * {
  ...
  <body>
      <div class="container">
          ...
          <a href="https://tb.netassist.ua" class="register-btn" target="_blank">Daftarkan nama domain gratis ip6.arpa</a>
          
          <form id="ssl-form">
              <div class="form-group">
                  <label for="email">Pendaftaran Email Cloudflare (Email)</label>
              ...
              <div class="form-group">
                  <label for="zone-id">ID wilayah domain (Zone ID)</label>
                  <input type="text" id="zone-id" placeholder="Silakan masukkan ID wilayah Domain Anda">
                  <div class="error-message" id="zone-id-error">Silakan masukkan ID wilayah yang valid</div>
              </div>
          ...
          <div class="info-box">
              ...
              <p>4. Alat ini menggunakan Cloudflare API untuk menambahkan sertifikat SSL ke domain IP6.ARPA Anda</p>
          </div>
  ...
  <body>
      <div class="container">
          <h1>Automatically add SSL certificate to IP6.ARPA domain</h1>
